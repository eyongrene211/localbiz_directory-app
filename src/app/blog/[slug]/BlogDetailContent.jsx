  ...
  return (
    <>
      ...
      <motion.div
        ...
        className="bg-gray-50 dark:bg-slate-800 py-4 mt-16"
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-12">
          <div className="max-w-4xl mx-auto">
            <motion.span
              ...
              className="inline-block px-4 py-2 bg-blue-600 text-white rounded-lg font-semibold mb-4"
            >
              {post.category}
            </motion.span>
            <motion.h1
      ...
      <div className="py-12 bg-white dark:bg-slate-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.2 }}
            className="bg-gray-50 dark:bg-slate-800 rounded-2xl p-6 md:p-8 mb-8 border border-slate-200 dark:border-slate-700"
          >
            ...
            <motion.div
              ...
              className="mt-6 pt-6 border-t border-slate-200 dark:border-slate-700 flex flex-col sm:flex-row items-center justify-between gap-4"
            >
              <div>
              ...
              <div className="flex gap-3 w-full sm:w-auto">
                ...
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="flex-1 sm:flex-none px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-colors"
                >
                  Register Now
                </motion.button>
              </div>
          ...
          <motion.div
            ...
            className="flex items-center gap-4 mb-8 pb-8 border-b border-slate-200 dark:border-slate-700"
          >
            <motion.img
      ...
      {relatedPosts.length > 0 && (
        <motion.div
          ...
          className="py-16 bg-gray-50 dark:bg-slate-800"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {relatedPosts.map((relatedPost, index) => (
                ...
                >
                  <EventComponent post={relatedPost} />
                </motion.div>
              ))}
            </div>
          </div>
