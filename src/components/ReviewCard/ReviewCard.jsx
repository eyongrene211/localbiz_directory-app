  ...
  return (
    <div className='w-full flex flex-col items-center justify-center px-4 py-8'>
      ...
      <div className='w-full max-w-md mx-auto mb-8'>
        <div className='gap-3 py-8 sm:py-12 md:py-16 lg:py-20 px-4 sm:px-6 md:px-8 lg:px-3 mb-5  shadow-2xs rounded-2xl flex flex-col justify-start items-center relative z-20 bg-gray-300'>
          {/* Diamond icon */}
          {/* <Diamond 
            className='absolute bottom-[-18px] left-1/2 transform -translate-x-1/2 z-70' 
            size={44} 
            color='#D1D1D1FF'  
          /> */}
          <div className='bg-gray-300 w-[20px] h-[20px] transform rotate-45 absolute bottom-[-10px] left-[48%] md:left-[65%] lg:left-[45%]'>
