...
const QuickViewCat = ({ label, IconComponent, href }) => {
  return (
    <Link href={href} className="group">
      ...
      <div className="mt-2 text-center text-xs sm:text-sm text-gray-200 dark:text-gray-200 font-medium group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
        {label}
      </div>
    </Link>
  )
